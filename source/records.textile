...
INFO: This works great if you are in control of your primary keys.  What do you do if you are relying on your datasource to set the key for you?  The answer is you must commit the master record first so the underlying datasource can provide a primary key like the following:
