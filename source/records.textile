...
WARNING: Property names defined on +SC.Record+ itself are reserved names, meaning they cannot be used for custom record attributes. Please refer to the "documentation of SC.Record":http://docs.sproutcore20.com/symbols/SC.Record.html for a list of all reserved names.
...
For a reference of how to specify your custom date format check the documentation of  "SC.DateTime#toFormattedString":http://docs.sproutcore20.com/symbols/SC.DateTime.html#toFormattedString.
...
NOTE: For a complete list of record state constants see the "documentation of the SC.Record class":http://docs.sproutcore20.com/symbols/SC.Record.html.
...
Please refer to the "documentation of SC.Array":http://docs.sproutcore20.com/symbols/SC.Array.html to learn more about the array access methods.
...
NOTE: If you need a custom sorting order, you can register your own comparison operator for a specific model attribute using +SC.Query.registerComparison+. Please refer to the "documentation":http://docs.sproutcore20.com/symbols/SC.Query.html#.registerComparison for further details.
