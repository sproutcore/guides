...
* Modify the application to ensure your changes are visible.
...
This directory can be your placed for all things SproutCore. Change directory to ~/development/sproutcore, then
...
So, go ahead and create the app, first changing directory to your new getting_started project directory:
...
Inside of the *apps/todos_one* directory, you will find the Buildfile for your TodosOne application.
...
The *main.js* file is usually very basic. It just starts your application. If you
...
you'll see that it simply appends your main view to the screen.
...
Lastly, the *resources/main_page.js* file describes the actual user interface of your
