...
Now you have a getting_started project directory, ~/somewhere/sproutcore/getting_started. We will build several SproutCore apps in this project space.
...
INFO: After you learn SproutCore, to start a new project or app, you can just copy from an existing project, or you can use sc-gen in this manner to generate a boilerplate hello-world app.
...
There is a project Buildfile in the project directory (~/somewhere/getting_started) and the Todos app has its own Buildfile in the root app directory (~/somewhere/getting_started/apps/todos/). Examine the Todos Buildfile and you will see only one configuration line:
...
There are four .js files in the Todos app root directory (~/somewhere/getting_started/apps/todos/):
...
<shell>
$ pwd 
    ~/somewhere/getting_started/apps/todos/
$ cd states
</shell> 
...
<shell>
$ pwd 
    ~/somewhere/getting_started/apps/todos/states
$ rm ready_state.js
</shell> 
...
NOTE: There are different conventions for naming states. The style used here makes the state names prominent. Some people like to camel-case the state names names.
...
<shell>
$ pwd 
    ~/somewhere/getting_started/apps/todos/resources/
$ cd ..
</shell>
...
<shell>
$ pwd 
    ~/somewhere/getting_started/apps/todos/resources/views/
$ cd ..
</shell>
...
<shell>
$ pwd 
    ~/somewhere/getting_started/apps/todos/models
$ cd ..
</shell>
...
<shell>
$ pwd 
    ~/somewhere/getting_started/apps/todos/controllers/
$ cd ..
</shell>
...
<shell>
$ pwd 
    ~/somewhere/getting_started/apps/todos/en/
$ mkdir fixtures
$ cd fixtures
</shell>
...
<shell>
$ pwd 
    ~/somewhere/getting_started/apps/todos/en/fixtures
$ cd ../../../..
</shell>
