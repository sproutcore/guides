...
This guide assumes you have already installed SproutCore. If you have not, please "install it now":http://www.sproutcore.com/redirect_to_install/.
...
* Bookmark the "SproutCore API Documentation":docs.sproutcore.com and the "SproutCore Guides":guides.sproutcore.com

h3. Continue On

Now that you've built a basic SproutCore app, continue on to "the next part of this tutorial":html_based_2.html to learn about working with SproutCore's model layer.
