...
So, go ahead and create the app in the getting_started project directory:
...
Go ahead and open up resources/main_page.js and change the "Welcome to SproutCore!"
...
"part two":/getting_started_2.html of the tutorial.
