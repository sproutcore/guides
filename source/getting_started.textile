...
This guide is designed to be as simple as possible and just ensure that you
...
NOTE: The dollar sign ($) in the code above and below represents your command line prompt and should not
be typed when executing the commands. Lines without a prompt generally show you the output of the previous
command.

This directory can be your place for all things SproutCore. Change directory to ~/development/sproutcore, then
...
So, go ahead and create the app:
...
When you are building your web application in SproutCore, it is common to have
a multitude of mini-applications in order to separate out the logic into
manageable chunks. For instance, Apple's MobileMe application has mini-apps for
e-mail, contacts and finding your friends.

This is why there is an *apps/* directory inside of your project directory. It
allows you to easily separate distinct portions of your application.

Inside of the *apps/* directory, you will find the Buildfile for your application.
Just like your project (getting_started) has a *Buildfile*, each application or
...
Your *core.js* file is the first file that gets loaded, and is where your actual
application is defined. This is also where you usually define any global
constants that your application might use (which should be very few), or any
configuration that external libraries might require.

The *main.js* file is usually very basic just starts your application. If you
are using the Statechart framework (which we will discuss in Part 2), *main.js*
would simply initialize your statechart. If you open up *main.js* right now,
you'll see that it simply appends your views to the screen.
...
Next, your *loading.rhtml* file defines the HTML that your users see before
SproutCore has fully loaded and handed control over to your application. For
now, it just displays a simple loading message.

Lastly, the *main_page.js* file describes the actual user interface of your
application. Open this file now and take a look. Depending upon how complex
your app becomes, you may decide to have just the mainPage and mainPane, or
...
So, we have our SproutCore application built, and we understand the basic
layout of the files. Let's see what it looks like in the browser!

Inside your project directory type the following command:
...
well, you should see "Welcome to Sproutcore!" in the middle of your screen!
...
re-opening the terminal to ensure that your paths are properly set.
