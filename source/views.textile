...
awakened when you +get+ the page:
...
<javascript>
// my_app/controllers/contacts.js
...
Right now it looks rather small, so let's add some style to it.

<css>
// my_app/resources/theme.css
...
<javascript>
// creepy_app/views/charles_jolley.js
...
to them. Let's recreate the last scenario using an +SC.RenderDelegate+:

<javascript>
// my_app/render_delegates/contact_name.js
...
* February 28, 2011: further updates by "Devin Torres":credits.html#dtorres
