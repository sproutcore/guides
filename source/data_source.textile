...
This design is simple, but as you can see, not very flexible, it only allows for one url. That won't get us very far. But given that all of our records are going to have a very similar URL, it should be simple to dynamically generated this URL.
...
* March 7, 2011: minor fixes/formatting by "Topher Fangio":credits.html#topherfangio
