...
This design is simple, but as you can see, not very flexible, it only allows for one url. That wont get us very far. But given that all of our records are going to have a very similar URL, it should be simple to dynamically generate this URL.
...
NOTE: The "fmt":http://docs.sproutcore.com/symbols/String.html#String#fmt function outputs a formatted string. If you are from a Java background, you'll know it as +String.Format+.
