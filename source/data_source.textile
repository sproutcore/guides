...
<javascript>
fetch: function(store, query) {
  SC.Request.getURL('/%@/'.fmt(query.recordType.resourcePath)).json()
    .notify(this, 'fetchDidComplete', store, query)
    .send()
...
The fetch method will now work for all record types.
