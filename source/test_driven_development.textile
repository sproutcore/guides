h2. Test-driven SproutCore Application Development
...
* Write tests that verify your bindings fire when you expect them to and how to incorporate +SC.RunLoop+ so that they
will function.
* _TODO_: more
