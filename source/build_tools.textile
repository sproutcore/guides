...
The reason for this is it quickly becomes too difficult and time consuming to manage multiple source files and assets and there are several important optimizations required for building and deploying top-of-class web experiences that are best left to automated scripts.
...
* Run CSS through the "Compass CSS Authoring Framework":http://compass-style.org/
