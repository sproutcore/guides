...
Therefore, a recommended setup would configure properties shared between all your apps within a project in the project's Buildfile and configure any properties specific to an app in the app's Buildfile.  For simplicity's sake, the following examples will just use a single Buildfile in most cases.
