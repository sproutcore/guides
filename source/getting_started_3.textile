...
TodosThree.SHOWING_DESTROY_CONFIRMATION = SC.State.design({
  enterState: function() {
    var panel = TodosThree.getPath('DestroyConfirmationPane');
    if (panel) {
      panel.append();
    }
  },
...
TodosThree.DestroyingConfirmationPane = SC.PanelPane.create({
  layout: { centerX: 0, top: 80, width: 380, height: 630 },
  theme: 'popover',
  defaultResponder: TodosThree.statechart,
  ...
  contentView: SC.WorkspaceView.design({
    ...
    contentView: SC.View.design({
      ...
      // info view should go here, for some substance
      // completedTodos SC.ListView <-> completedTodosController
