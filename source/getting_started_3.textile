...
Edit these files to assure their content matches that given in the following sections (code comments are not
...
the theming system. It defines $theme to be our Ace-derived theme, ace.todos-three We use $theme in CSS references.
