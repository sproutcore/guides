...
previous guide: views can be defined in separate javascript files and included where they are needed. exampleView 
is set to TodosThree.TodoItemView, which necessitates the sc_require statement at the top of the file: 
sc_require('todo_item');. TodoItemView has a checkbox and label.
