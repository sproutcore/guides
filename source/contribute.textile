...
TIP: You will need the "Ruby language":http://www.ruby-lang.org/ and the "Ruby Gems package manager":http://rubygems.org/ installed on your machine for this next part.
...
To make sure our local copy of the SproutCore Guides source code is up to date, we use the "+git pull+":http://www.kernel.org/pub/software/scm/git/docs/git-pull.html command:
...
TIP: Everyone will see this branch name when you submit your changes to the main SproutCore Guides repository, so choose something that has to do with the nature of the changes you are making.

h3. Create or Modify a Guide

The guides are written in a modified version of the "Textile markup language":http://en.wikipedia.org/wiki/Textile_(markup_language) and reside in the +source+ directory. Textile is meant to be human friendly markup language (unlike HTML) and should be easy to pick up; looking at the existing guides should quickly get you up to speed on how to use it.

h4. Creating a New Guide
...
h4. Modifying an Existing Guide
