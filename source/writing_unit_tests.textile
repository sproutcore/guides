...
Once you've defined a module, you can add individual unit test cases.  A unit test case
is defined using the +test()+ method.  A test should have a description followed
by the function you want to execute to perform the test.  
...
There are several other assertion types that you can learn about from the "QUnit pages":http://docs.jquery.com/QUnit#API_documentation, such as
