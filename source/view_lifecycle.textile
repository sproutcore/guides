...
A template function writes a combination of HTML and JavaScript properties to a render buff in order to create a fully-formed view. As it renders, it may also create and add new child views to the parent view.
