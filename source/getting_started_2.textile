...
If you still have your Todos app from the first part of this guide, use that. If not, you can get a "completed version":https://www.github.com/sproutcore/Todos-Example from GitHub.
