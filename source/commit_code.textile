...
+http://localhost:4020/"framework or app name"/en/current/tests.html+ -> all the tests
+http://localhost:4020/"framework or app name"/en/current/tests/path/to/your/tests.html+ -> run a specific set
